...
export const Layout: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  return (
    <div className="flex min-h-screen bg-zinc-50">
      ...
      <aside className={`
        fixed lg:static inset-y-0 left-0 w-64 bg-white border-r border-zinc-200 z-50 transform transition-transform duration-300
      ...
      <main className="flex-1 pt-20 lg:pt-8 px-4 lg:px-10 pb-12 overflow-x-hidden">
